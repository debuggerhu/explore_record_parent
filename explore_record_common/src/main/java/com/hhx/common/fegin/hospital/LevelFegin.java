...
import com.hhx.common.dto.hospital.HospitalevelDTO;
...
public interface LevelFegin {

    @GetMapping("/fegin/level/list")
    ResponseEntity<ResponseData<List<HospitalevelDTO>>> list();
}
