...
public interface PacsRoleFegin {
    /**
     * 获取角色列表
     * 获取角色列表
     *
     ...
     * @return 修改医院角色结果
     */
    @PostMapping("/fegin/role/updateAction")
