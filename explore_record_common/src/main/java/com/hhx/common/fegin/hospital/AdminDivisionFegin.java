...
import com.hhx.common.dto.hospital.AdminDivisionDTO;
...
public interface AdminDivisionFegin {

    @GetMapping("/fegin/admin_division/list")
    ResponseEntity<ResponseData<List<AdminDivisionDTO>>> list();
}
